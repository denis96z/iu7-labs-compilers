...
#[test]
fn test_bin_tree_new() {
    assert_eq!(BinTree::<char>::new(), BinTree::Empty);
}

#[test]
fn test_bin_tree_from_element() {
    let element = 'a';
...
#[test]
fn test_bin_tree_from_element_with_left() {
...
#[test]
fn test_bin_tree_from_element_with_right() {
...
#[test]
fn test_bin_tree_from_elements() {
